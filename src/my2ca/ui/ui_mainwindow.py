...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_2.addWidget(self.tablesList, 0, 0, 1, 1)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 388, 484))
        self.scrollAreaWidgetContents.setObjectName("scrollAreaWidgetContents")
        self.erdArea.setWidget(self.scrollAreaWidgetContents)
        self.gridLayout_2.addWidget(self.erdArea, 0, 1, 1, 1)
        ...
        self.toolsDock = QtGui.QDockWidget(MainWindow)
        self.toolsDock.setObjectName("toolsDock")
        self.dockWidgetContents = QtGui.QWidget()
        self.dockWidgetContents.setObjectName("dockWidgetContents")
        self.gridLayout = QtGui.QGridLayout(self.dockWidgetContents)
        self.gridLayout.setObjectName("gridLayout")
        self.connectButton = QtGui.QPushButton(self.dockWidgetContents)
        ...
        self.genModelButton = QtGui.QPushButton(self.dockWidgetContents)
        self.genModelButton.setObjectName("genModelButton")
        self.gridLayout.addWidget(self.genModelButton, 0, 1, 1, 1)
        self.pushButton = QtGui.QPushButton(self.dockWidgetContents)
        self.pushButton.setObjectName("pushButton")
        self.gridLayout.addWidget(self.pushButton, 0, 2, 1, 1)
        self.toolsDock.setWidget(self.dockWidgetContents)
        MainWindow.addDockWidget(QtCore.Qt.DockWidgetArea(4), self.toolsDock)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.connectButton.setText(QtGui.QApplication.translate("MainWindow", "Connect MySQL Database", None, QtGui.QApplication.UnicodeUTF8))
        self.genModelButton.setText(QtGui.QApplication.translate("MainWindow", "Generate Cassandra Model", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButton.setText(QtGui.QApplication.translate("MainWindow", "Generate Entity Classes", None, QtGui.QApplication.UnicodeUTF8))
